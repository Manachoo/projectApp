                                    ...
                                    <form class="mx-1 mx-md-4" method="POST" action="">
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="text" id="form3Example1c" class="form-control" id="rut" name="rut"/>
                                                <label class="form-label" for="form3Example1c">Ingresa tu rut</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="text" id="form3Example1c" class="form-control" id="nombre" name="nombre"/>
                                                <label class="form-label" for="form3Example1c">Ingres tu nombre</label>
                                            </div>
                                        </div>
